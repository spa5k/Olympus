...
export namespace Prisma {
  ...
  */
  ...
  export type AggregateTokens = {
    count: TokensCountAggregateOutputType | null
    min: TokensMinAggregateOutputType | null
    max: TokensMaxAggregateOutputType | null
  }
  ...
  export type TokensAggregateArgs = {
    ...
    **/
    orderBy?: Enumerable<tokensOrderByInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
    ...
    **/
    count?: true | TokensCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    min?: TokensMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    max?: TokensMaxAggregateInputType
  }

  export type GetTokensAggregateType<T extends TokensAggregateArgs> = {
    [P in keyof T & keyof AggregateTokens]: P extends 'count'
      ? T[P] extends true
        ? number
  ...
  export type tokensGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof tokens ?tokens [P]
  : 
     never
  } 
    : tokens
